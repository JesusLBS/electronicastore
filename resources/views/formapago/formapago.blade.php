              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="Forma de pago">Forma de pago</th>
                ...
                <tbody class="list">
                  ...
                  <tr>
                    <td>
                      <span class="">{{$formap->id_forma_pago}}</span>
                    </td>
                    <td>
                      <span class="">{{$formap->forma_pago}}</span>
                    </td>
                    <td class="text-center">
                      @if($formap->deleted_at)
                        ...
                        @endif  
                        <a href="{{route('editar_formpago',['id_forma_pago'=>$formap->id_forma_pago])}}"><button type="button submit" class="btn btn-outline-primary"><i class="far fa-edit edit" title="Editar"></i></button></a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
